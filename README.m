...
<      centro      ><      img       src      =      ''       altura      =      "200"      ></      centro      > https://i.ibb.co/Jy4jKqd/Screenshot-20230511-163327.png
...
-   `make   add  -  token   asset_id  =  c60_`   --   Crear   `info . json`   como  plantilla   de  activos .  0x7E20f650Cd25B72813280933f2754d651601AE6B
-  `make    add    -   tokenlist   asset_id   =   c60_`   —   Agrega   un   token   a   la   lista   de   tokens . json_  0x7E20f650Cd25B72813280933f2754d651601AE6B _       
-`make 0x7E20f650Cd25B72813280933f2754d651601AE6Badd   - tokenlist - extended asset_id = c60_` — Agrega un token a tokenlist - extended . _   _ json _                       
